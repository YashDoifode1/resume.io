...
// Stop if registration disabled
if (!ADMIN_REGISTRATION_ENABLED) {
    die("Admin registration is disabled.");
}
...
// ALWAYS generate a fresh CSRF token on page load
...
<div class="card">
    ...
    <?php if (isset($_GET['success'])): ?>
        <div class="success">Admin created successfully</div>
    <?php endif; ?>
