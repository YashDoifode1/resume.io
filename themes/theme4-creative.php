<?php
/**
 * Creative Portfolio Theme – FIXED PREVIEW VERSION
 */
        ...
        <div class="resume-section">
            ...
            <?php foreach ($data['workExperience'] as $exp): ?>
                <div class="experience-item">
                    <table width="100%">
                        <tr>
                            <td><strong><?= htmlspecialchars($exp['jobRole'] ?? ''); ?></strong></td>
                            <td class="date">
        ...
        <div class="resume-section">
            ...
            <?php foreach ($data['projects'] as $project): ?>
                <div class="project-item">
                    <strong><?= htmlspecialchars($project['projectName'] ?? ''); ?></strong>
        ...
        <div class="resume-section">
            ...
            <?php foreach ($data['certifications'] as $cert): ?>
                <div class="certification-item">
                    <strong><?= htmlspecialchars($cert['certificateTitle'] ?? ''); ?></strong>
