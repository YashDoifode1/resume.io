<?php
/**
 * Tech Graphite Sidebar Theme
 * Dark sidebar – Developer / IT focused
 * PDF Safe + ATS Friendly
 */
...
<td class="sidebar">
    ...
    <p class="job-title"><?= htmlspecialchars($data['personal']['jobTitle'] ?? 'Software Engineer'); ?></p>
